...
const SANITIZE_CONFIG = {
  ...
  ALLOWED_TAGS: [
    ...
    'ac:structured-macro', 'ac:plain-text-body', 'ac:parameter',
    'ac:link', 'ac:image', 'ri:page', 'ri:attachment'
  ],
  // Allow a broad range of attributes
  ALLOWED_ATTR: [
    'href', 'src', 'alt', 'title', 'class', 'style', 'id',
    'width', 'height', 'align', 'data-attachment-type', 'data-attachment-name',
    'data-macro-name', 'ac:name', 'ac:schema-version',
    'ri:content-title', 'ri:version-at-save'
  ],
